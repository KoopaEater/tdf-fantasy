...
<div class="outer-wrapper">
    <div class="wrapper">
        <ScoreLabel score="71" scorecolor="var(--color-gold)">
        ...
        <ScoreLabel score="35" >
            <TeamNameLeader teamname="Et andet hold der er meget langt" leader="En anden person"/>
        </ScoreLabel>
    </div>
</div>
